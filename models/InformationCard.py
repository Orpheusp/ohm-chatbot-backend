...
from models.typedefs import INFORMATION_CARD_RESOURCE_CODE_REGEX, INFORMATION_CARD_TYPE, INFORMATION_CARD_RESOURCE_TYPE
...
class InformationCardResourceDocument(EmbeddedDocument):
    ...
    resource_type = StringField(
        ...
        choices=INFORMATION_CARD_RESOURCE_TYPE.values()
    )
